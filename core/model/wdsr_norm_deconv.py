...
from .NormConvTranspose2d import NormConvTranspose2d
...
class WDSR_Norm_Deconv(nn.Module):
    ...
    def __init__(self, args):
        ...
        tail = [NormConvTranspose2d(args.n_feats, 3, kernel_size=3, stride=args.scale, padding=1, output_padding=1)]
        skip = [NormConvTranspose2d(3, 3, kernel_size=5, stride=args.scale, padding=2, output_padding=1)]
